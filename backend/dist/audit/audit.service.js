...
let AuditService = class AuditService {
    ...
    async log(entidad, entidadId, accion, usuarioId, usuarioNombre, datosAnteriores, datosNuevos, descripcion) {
        const auditData = {
            entidad,
            entidadId,
            accion,
    ...
    async getByEntity(entidad, entidadId) {
    ...
    async getByUser(usuarioId, limit = 50) {
        return this.auditRepository.find({
            where: { usuarioId },
            order: { createdAt: 'DESC' },
            take: limit,
